...
public class LLVMGenerator {
    ...
    static void printf(String id){
        main_text += "%"+tmp+" = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @strp, i32 0, i32 0), i32 "+id+")\n";
        tmp++;
    }

    static void scanf(String id){
        main_text += "%"+tmp+" = call i32 (i8*, ...)* @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8]* @strs, i32 0, i32 0), i32* %"+id+")\n";
        tmp++;
    }
